<template>
  <div class="pa-2 caption">
    <p>
      Want to give us a feedback or a suggestion? Please fill an
      <a href="https://github.com/LyonDataViz/occupapp/issues/new">issue</a>.
    </p>
    <p class="credits ma-0">
      <img
        ...
        height
      > Developed for the
      <a href="https://projet.liris.cnrs.fr/mi2/">M2i</a> project (version:
      <a :href="appVersionUrl">{{ appVersion }}</a>, commit: <a :href="gitUrl">{{ gitVersion }}</a>)
    </p>
  </div>
</template>
...
export default class Infos extends Vue {
  ...
  get appVersionUrl (): string | undefined {
